      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(
            seedColor: const Color(0xFF3A5FF5),
            primary: const Color(0xFF3A5FF5),
          ),
          ...
          textSelectionTheme: const TextSelectionThemeData(
            cursorColor: Color(0xFF3A5FF5),
            selectionColor: Color(0x333A5FF5),
            selectionHandleColor: Color(0xFF3A5FF5),
          ),
        ),
        // theme: ThemeData(
        ...
        routes: {
          ...
          routeNameSearchResultPage: (context) => const ResultPage(),
